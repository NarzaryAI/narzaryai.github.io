	...
	return (
		<MobileMenuProvider>
			...
			>
				...
				<TitleAndMetaTags
					title="Angfungwra Brahma | Narzary Engineering & Consultancy Pvt. Ltd."
					description="Angfungwra Brahma - Director & Co-founder of Narzary Engineering & Consultancy Pvt. Ltd."
					image="narzary.png"
				/>
						...
						<Grid columns={{ initial: "1", sm: "2", md: "3" }} gap="5" mb="7">
							...
							<Card>
								<Flex align="center" gap="3">
									<Avatar fallback size="7" src="/avatars/anfungwra.png" alt="Kanishka Brahma">
										<AvatarIconFallback />
									</Avatar>
							...
							<AnfungwraBasicProfile />
							<AnfungwraBasicProfileMore />
						</Grid>
...
const AnfungwraBasicProfile = ({ highContrast = false }) => (
	<Blockquote>
		Anfungwra Brahma is a Computer Science & Engineering (B.Tech) graduate from{" "}
		<HoverCard.Root>
			<HoverCard.Trigger>
				<Link
					underline="hover"
			...
			<HoverCard.Content>
				<Flex>
					...
					<Text as="p" size="2" style={{ maxWidth: 250 }}>
						Anfungwra completed his{" "}
						<Strong>B.Tech in Computer Science & Engineering</Strong> at the
						Central Institute of Technology, Kokrajhar. He is currently
						pursuing an <Strong>M.Tech in Computer Science & Engineering</Strong>,
						with a focus on <Strong>Artificial Intelligence</Strong> and{" "}
						<Strong>Machine Learning</Strong>.
					</Text>
				</Flex>
			</HoverCard.Content>
		</HoverCard.Root>
		. After graduation he gained industry experience working on practical
		engineering and product development.  He is an experienced NLP practitioner and a strong Python engineer.
	</Blockquote>
);

const AnfungwraBasicProfileMore = ({ highContrast = false }) => (
	<Blockquote>
		
		He is an experienced developer and a
		strong Python engineer, familiar with platforms and technologies such as{" "}
		<Strong>Linux</Strong>, <Strong>Python</Strong>, <Strong>Next.js</Strong>,{" "}
		<Strong>Laravel</Strong>, and more, applying his skills to build robust,
		practical solutions. He is from Dotma {" "}
		<HoverCard.Root>
			<HoverCard.Trigger>
				<Link
					underline="hover"
					highContrast={highContrast}
					target="_blank"
					href="https://en.wikipedia.org/wiki/Dotma"
				>
					Dotma
				</Link>
			</HoverCard.Trigger>
			<HoverCard.Content>
				<Flex>
					...
					<Text as="p" size="2" style={{ maxWidth: 250 }}>
						Dotma is a town in the Kokrajhar district of Assam, India, within the Bodoland
						Territorial Region. It is a local market and transit hub with a mixed Bodo and
						Assamese population, known for its cultural traditions and close ties to the
