		...
		<MobileMenuProvider>
			...
			<Container mx={{ initial: "5", xs: "6", sm: "7", md: "9" }}>
				<Section size={{ initial: "2", md: "4" }}>
					...
					>
						<NextLink
							href="/products/case-studies/acid-tango"
							passHref
							legacyBehavior
						>
						...
						<NextLink
							href="/products/case-studies/atom-learning"
							passHref
							legacyBehavior
						>
							<LogoLink variant="box">
						...
						<NextLink
							href="/products/case-studies/composer"
							passHref
							legacyBehavior
						>
							<LogoLink variant="box">
						...
						<NextLink
							href="/products/case-studies/compound"
							passHref
							legacyBehavior
						>
							<LogoLink variant="box">
						...
						<NextLink
							href="/products/case-studies/magnetis"
							passHref
							legacyBehavior
						>
							<LogoLink variant="box">
						...
						<NextLink
							href="/products/case-studies/teamflow"
							passHref
							legacyBehavior
						>
							<LogoLink variant="box">
